        ...
        <div class="row">
            <div class="col-lg-7">
                <div class="sub-banner-inner-con">
                    <h4>Khám phá những địa điểm</h4>
                    <p class="font-size-20">Xem ngay những điểm đến thú vị bên dưới!</p>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <ul class="list-group">
                            ...
                            <li class="list-group-item"><a href="?quan_huyen={{ $item->ma_quan_huyen }}">{{ $item->ten_quan_huyen }}</a></li>
                            @endforeach
                        </ul>
                    </div>
                    <div class="col-md-9">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-aos="fade-up" data-aos-duration="700">
                                <div class="blog-box blog-box1">
                                    <figure class="blog-image mb-0">
                                        <img src="{{ $item->hinh_anh_dia_diem }}" alt="{{ $item->ten_dia_diem }}" class="img-fluid" loading="lazy">
                                    </figure>
                                    <div class="lower-portion">
                                        <div class="span-i-con">
                                            <i class="tag-mb fa-solid fa-tag"></i>
                                            <span class="text-size-14">{{ $item->loaiDiaDiem->ten_loai_dia_diem }}</span>
                                        </div>
                                        <a href="/chi-tiet-dia-diem/{{ $item->ma_dia_diem }}">
                                            <h5 class="text-single-line">{{ $item->ten_dia_diem }}</h5>
                                        </a>
                                    </div>
