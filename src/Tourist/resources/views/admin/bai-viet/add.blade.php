...
<div class="container-fluid">
    <h1 class="h3 mb-1 text-gray-800">Thêm bài viết</h1>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="file" class="dropify" name="hinh_anh_bai_viet" />
                    </div>
                    <div class="col-md-8">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea id="summernote" name="noi_dung_bai_viet"></textarea>
                        </div>
                    </div>
                </div>
            </div>
